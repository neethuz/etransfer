function LoadPartners(response) {
    if (response.status_code == "+Ok") {
        ...
        for (var partner in partners) {
            ...
            var xpcontrol = "<span class='outerprogress'><span class='innerprogress' style='width:" + width + "% !important; background:url(xp.png) repeat-x;'><span class='progressval'>" + xpscore + "/" + xpmax.replace(',00', '') + "  xp</span></span></span>";
